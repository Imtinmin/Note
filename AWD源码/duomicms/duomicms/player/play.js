var zzid=0;
var piduomi_Player_File="play2.swf";//播放器款式
var playerw='100%';//播放器宽度
var playerh='510';//播放器高度
...
function video_diy(){
	...
	var header3 = "<a href=\"javascript:void(0)\" onClick=\"parent.video_opens(this);\">选集列表</a>";
