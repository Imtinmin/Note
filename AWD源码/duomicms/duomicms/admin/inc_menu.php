...
$menu=array (
	...
	'gathersoft'=>array (
		...
		3=>"<a target='I2' href='admin_collect.php?action=main'>影片采集项目列表</a>",
		4=>"<a target='I2' href='admin_collect.php?action=add'>添加影片采集项目</a>",
		5=>"<a target='I2' href='admin_collect.php?action=customercls'>影片采集分类转换</a>",
		6=>"<a target='I2' href='admin_collect.php?action=filters'>影片采集信息过滤</a>",
		7=>"<a target='I2' href='admin_collect.php?action=tempdatabase'>已采集影片库</a>",
		8=>"<a target='I2' href='admin_collect.php?action=importrule'>导入影片采集规则</a>",
		9=>"",
		10=>"<a target='I2' href='admin_collect_news.php?action=main'>资讯采集项目列表</a>",
		11=>"<a target='I2' href='admin_collect_news.php?action=add'>添加资讯采集项目</a>",
		12=>"<a target='I2' href='admin_collect_news.php?action=customercls'>资讯采集分类转换</a>",
		13=>"<a target='I2' href='admin_collect_news.php?action=filters'>资讯采集信息过滤</a>",
		14=>"<a target='I2' href='admin_collect_news.php?action=tempdatabase'>已采集资讯库</a>",
		15=>"<a target='I2' href='admin_collect_news.php?action=importrule'>导入资讯采集规则</a>",
