...
var OpenPricureDialog = function(type, ADMIN_MAIN, number , spec_id, spec_value_id) {
	if (number  == null || number  == '' || number  == 0) {
		number  = 1;
	}
	if (type == "PopPicure") {
		art.dialog.open(__URL(ADMIN_MAIN + '/system/dialogalbumlist?number='+ number +'&spec_id='+spec_id+'&spec_value_id='+spec_value_id), {
			lock : true,
			title : "我的图片",
			width : 860,
			height : 620,
