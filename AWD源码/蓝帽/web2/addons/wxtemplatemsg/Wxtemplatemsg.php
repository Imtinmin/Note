...
class Wxtemplatemsg extends \addons\Addons
{
    ...
    public function wxtemplatemsg($params = [])
    {
        ...
        $this->assign('url', addons_url('wxtemplatemsg://wxtemplatemsg/getTemplateId'));
        $this->assign('change_is_enable_url', addons_url('wxtemplatemsg://wxtemplatemsg/changeIsEnable'));
