 ...
 * @return boolean
 */
function emailSend($email_host, $email_id, $email_pass, $email_addr, $toemail, $title, $content, $shopName = "")
{
    $result = false;
    try {
        $mail = new Email();
...
function addons_url($url, $param = [])
{
    ...
    return url("shop/addons/execute", $params);
}
