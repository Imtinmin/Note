<?php if (!defined('THINK_PATH')) exit(); /*a:13:{s:37:"template/shop/blue//Member/index.html";i:1501656020;s:28:"template/shop/blue/base.html";i:1501842882;s:32:"template/shop/blue/urlModel.html";i:1501656016;s:34:"template/shop/blue/controlTop.html";i:1501656020;s:41:"template/shop/blue/controlHeadSerach.html";i:1501656020;s:44:"template/shop/blue/controlHeadSearchAdv.html";i:1500458998;s:43:"template/shop/blue/controlHeadGoodType.html";i:1501808090;s:40:"template/shop/blue/controlCommonNav.html";i:1501551342;s:46:"template/shop/blue/Member/controlLeftMenu.html";i:1501656020;s:45:"template/shop/blue/controlBottomLinkHelp.html";i:1501551342;s:37:"template/shop/blue/controlBottom.html";i:1501752182;s:36:"template/shop/blue/controlLogin.html";i:1501836248;s:37:"template/shop/blue/baidu_js_push.html";i:1499844478;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="member-menu">
	<div class="user-info">
		...
		<div class="logo" onclick="location.href='{__URL('SHOP_MAIN/member/person')}';" title="查看个人资料">
		...
		<strong onclick="location.href='<?php echo __URL('SHOP_MAIN/member/person'); ?>';" title="查看个人资料"><?php echo $member_info['user_info']['nick_name']; ?></strong>
	</div>
	<article class="list">
		<div class="item">
			<h3>
			...
			<ul>
				<li onclick="location.href='<?php echo __URL('SHOP_MAIN/member/index'); ?>';" data-href="<?php echo __URL('SHOP_MAIN/member/index'); ?>">
					<span>欢迎页</span>
...
$(function(){
	...
	<article class="member-main">
		...
		<div class="block">
			...
			<div class="assets">
				<ul>
					<li onclick="location.href='<?php echo __URL('SHOP_MAIN/member/balancelist'); ?>'" title="查看余额" data-flag="i-balance">
						<header>
					...
					<li onclick="location.href='<?php echo __URL('SHOP_MAIN/member/integrallist'); ?>'" title="查看积分" data-flag="i-integral">
						<header>
					...
					<li onclick="location.href='<?php echo __URL('SHOP_MAIN/member/vouchers'); ?>'" title="查看优惠券" data-flag="i-coupons">
						<header>
			...
			<div class="security">
				<div class="security-level">
					...
					<?php endif; ?>
					<a href="<?php echo __URL('SHOP_MAIN/member/usersecurity'); ?>" title="提升账户安全等级">提升 &gt;</a>
				</div>
				<div class="info">
					<?php if($member_info['user_info']['user_tel'] != ''): ?>
					<label>手机</label>
					<span><?php echo $member_info['user_info']['user_tel']; ?></span>
					<a href="<?php echo __URL('SHOP_MAIN/member/usersecurity?atc=user_mobile'); ?>">解除绑定</a>
					<?php else: ?>
					<label style="margin-right:10px;">手机</label>
					<a href="<?php echo __URL('SHOP_MAIN/member/usersecurity?atc=user_mobile'); ?>">未绑定</a>
					<?php endif; ?>
				</div>
				<div class="info">
					...
					<a href="<?php echo __URL('SHOP_MAIN/member/usersecurity?atc=user_email'); ?>">解除绑定</a>
					<?php else: ?>
					<label style="margin-right:10px;">邮箱</label>
					<a href="<?php echo __URL('SHOP_MAIN/member/usersecurity?atc=user_email'); ?>">未绑定</a>
					<?php endif; ?>
				</div>
			</div>
		</div>
		...
		<div class="block">
			...
			<div class="trading-to-remind">
				...
				<h4>交易提醒<span onclick="location.href='<?php echo __URL('SHOP_MAIN/member/orderlist'); ?>';">查看全部订单<i class="icon i-arrow"></i></span></h4>
				<header>
					<ul>
						<li onclick="location.href='<?php echo __URL('SHOP_MAIN/member/orderlist?status=0'); ?>';">待付款<span>(<?php echo $wait_pay_num; ?>)</span></li>
						<li onclick="location.href='<?php echo __URL('SHOP_MAIN/member/orderlist?status=5'); ?>';">待评价<span>(<?php echo $wait_evaluate; ?>)</span></li>
					</ul>
				</header>
				<article class="order-list">
					...
					<table>
						...
						<tr>
							...
							<td>
								<a href="<?php echo __URL('SHOP_MAIN/member/orderdetail','orderid='.$order['order_id']); ?>" title="查看订单" target="_blank">查看</a>
							</td>
						</tr>
						<?php endforeach; ?>
					</table>
					...
					<div class="no-order-data">
						...
						<p>您好久没在商城购物了，赶快<span onclick="location.href='<?php echo __URL('SHOP_MAIN'); ?>';">去看看</span>吧！</p>
					</div>
					<?php endif; ?>
				</article>
			</div>
			...
			<div class="my-shopping-cart">
				...
				<div class="list">
					...
					<p style="text-align: center;font-size: 12px;margin: 10px 0;padding-bottom: 5px;">
						<a href="<?php echo __URL('SHOP_MAIN/goods/cart'); ?>" target="_blank" title="查看购物车所有商品">查看购物车所有商品<i class="icon i-arrow"></i></a>
					</p>
				</div>
				<?php else: ?>
				<div class="no-cart-data">
					<i class="icon i-shipping-cart"></i>
					<p>您的购物车中还没有商品<br/>赶快<span onclick="location.href='<?php echo __URL('SHOP_MAIN'); ?>';">去看看</span>吧！</p>
				</div>
				<?php endif; ?>
		...
		<div class="goods-collection">
			<h4>商品收藏<span onclick="location.href='<?php echo __URL('SHOP_MAIN/member/goodscollectionlist'); ?>';">查看收藏的所有商品<i class="icon i-arrow"></i></span></h4>
			<hr class="divider"/>
			...
			<div class="no-collection-data">
				...
				<p>您还没有收藏任何商品，赶快<span onclick="location.href='<?php echo __URL('SHOP_MAIN'); ?>';">去看看</span>吧！</p>
			</div>
			<?php endif; ?>
		</div>
	</article>
