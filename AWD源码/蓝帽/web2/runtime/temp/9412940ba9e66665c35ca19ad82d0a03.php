<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:35:"template/shop/blue/Login/login.html";i:1501849132;s:32:"template/shop/blue/urlModel.html";i:1501656016;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="user_head_bg">
	<div class="user_head">
		<div class="logobox" style="padding-top:20px;"><a href="<?php echo __URL('SHOP_MAIN'); ?>"><img src="__UPLOAD__/<?php echo $web_info['logo']; ?>" border="0" class="web-logo"></a></div>
		<div class="reg">
