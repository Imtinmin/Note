...
<li><a href="ADMIN_MAIN/wchat/addmedia"><i class="fa fa-plus-circle"></i>&nbsp;添加消息</a></li>
			...
			if (data["data"].length > 0) {
				for (var i = 0; i < data["data"].length; i++) {
					...
					for(var l=0; l<data['data'][i]['item_list'].length; l++){
						html += '<li><span class="type_name">'+ type_name +' </span><a href="#">'+timeStampTurnTime(data['data'][i]['item_list'][l]['title'])+'</a></li>';
					}
					html += '';
					html += '</ul></td>';
