...
<div style="padding:30px;">
	...
	<div class="binding">
		<div class="input-prepend control-group">
			...
			<input class="span2 input-common" id="appid" placeholder="AppID" value="<?php echo $wchat_config['appid']; ?>" type="text" >
			<span class="help-inline"></span>
		</div>
		<div class="mt8"></div>
		<div class="input-prepend control-group">
			<span class="add-on"><i class="icon-lock"></i></span>
			<input class="span2 input-common" id="appsecret" type="text" placeholder="Appsecret" value="<?php echo $wchat_config['appsecret']; ?>">
			<span class="help-inline"></span>
		</div>
		<p class="muted mt8">
