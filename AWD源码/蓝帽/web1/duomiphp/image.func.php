...
{
	include(duomi_DATA.'/mark/inc_photowatermark_config.php');
	...
	if($fromGo=='down' && $photo_markdown=='0')
	{
 	...
 	$trueMarkimg = duomi_DATA.'/mark/'.$photo_markimg;
	...
	if($photo_marktype == '2')
	{
	if(file_exists(duomi_DATA.'/mark/simhei.ttf'))
	{
		$cfg_watermarktext['fontpath'] =  duomi_DATA.'/mark/simhei.ttf';
	}
	else
	{
		return ;
