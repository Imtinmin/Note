...
--
-- Table structure for table `yx_admin`
--
...
--
-- Dumping data for table `yx_admin`
--

LOCK TABLES `yx_admin` WRITE;
/*!40000 ALTER TABLE `yx_admin` DISABLE KEYS */;
INSERT INTO `yx_admin` VALUES (1,1,'admin','YX','168a73655bfecefdb15b14984dd2ad60',1528421901,'172.20.23.124',0,'','');
/*!40000 ALTER TABLE `yx_admin` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `yx_collectrules`
--
...
--
-- Dumping data for table `yx_collectrules`
--

LOCK TABLES `yx_collectrules` WRITE;
...
--
-- Table structure for table `yx_extend`
--
...
--
-- Dumping data for table `yx_extend`
--

LOCK TABLES `yx_extend` WRITE;
/*!40000 ALTER TABLE `yx_extend` DISABLE KEYS */;
INSERT INTO `yx_extend` VALUES (7,0,'extend_conment',1,'','内容评论',0,0),(8,7,'aid',1,'0','资讯id',0,2),(9,7,'comby',1,'','评论者',0,4),(10,7,'comcontent',3,'','评论内容',0,3),(11,7,'type',1,'0','类型',0,1),(12,0,'extend_guestbook',1,'','留言本',0,0),(13,12,'tname',1,'','姓名',0,0),(14,12,'tel',1,'','电话',0,0),(15,12,'qq',1,'','QQ',0,0),(16,12,'content',3,'','留言内容',0,0),(17,12,'reply',2,'','回复内容',0,0),(18,0,'extend_product',0,'','产品信息',0,0),(19,18,'pinpai',1,'','品牌',0,0),(20,18,'caizhi',1,'','材质',0,0),(21,18,'chandi',1,'','产地',0,0),(22,18,'jiage',1,'0','价格',0,0),(23,7,'title',2,'','标题',0,5),(24,7,'sortname',1,'','栏目名称',0,6),(25,7,'backcontent',2,'','评论回复',0,0);
/*!40000 ALTER TABLE `yx_extend` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `yx_extend_conment`
--
...
--
-- Dumping data for table `yx_extend_conment`
--

LOCK TABLES `yx_extend_conment` WRITE;
/*!40000 ALTER TABLE `yx_extend_conment` DISABLE KEYS */;
/*!40000 ALTER TABLE `yx_extend_conment` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `yx_extend_guestbook`
--
...
--
-- Dumping data for table `yx_extend_guestbook`
--

LOCK TABLES `yx_extend_guestbook` WRITE;
/*!40000 ALTER TABLE `yx_extend_guestbook` DISABLE KEYS */;
INSERT INTO `yx_extend_guestbook` VALUES (1,1439525302,'unknown',1,'李某某','13865748765','404133748','测试内容','测试回复'),(2,1528421787,'172.20.11.163',0,'asd','sd','asd','&lt;sc&lt;x&gt;ript&gt;alter(\\\'\\\'xxxx\\\')&lt;/sc&lt;x&gt;ript&gt;','');
/*!40000 ALTER TABLE `yx_extend_guestbook` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `yx_extend_product`
--
...
--
-- Dumping data for table `yx_extend_product`
--

LOCK TABLES `yx_extend_product` WRITE;
/*!40000 ALTER TABLE `yx_extend_product` DISABLE KEYS */;
INSERT INTO `yx_extend_product` VALUES (1,'','','',''),(2,'','','',''),(3,'山水之间','陶瓷','景德镇市茶餐具','99'),(4,'宜兴龙纹','紫砂','江苏宜兴','2000'),(5,'housing','陶瓷','英国','30'),(6,'Zassenhaus','原木，钢','德国','300');
/*!40000 ALTER TABLE `yx_extend_product` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `yx_fragment`
--
...
--
-- Dumping data for table `yx_fragment`
--

LOCK TABLES `yx_fragment` WRITE;
...
--
-- Table structure for table `yx_group`
--
...
--
-- Dumping data for table `yx_group`
--

LOCK TABLES `yx_group` WRITE;
/*!40000 ALTER TABLE `yx_group` DISABLE KEYS */;
INSERT INTO `yx_group` VALUES (1,'超级管理员','-1'),(2,'网站编辑','283,1,228,10,11,12,13,14,15,16,157,158,174,268,288,317,22,23,24,25,26,27,150,151,152,153,154,155,156,159,160,269,289,290,291,318,188,189,190,191,192,229,238,239,240,241,243,244,308,309,310,311,312,313');
...
--
-- Dumping data for table `yx_link`
--

LOCK TABLES `yx_link` WRITE;
/*!40000 ALTER TABLE `yx_link` DISABLE KEYS */;
INSERT INTO `yx_link` VALUES (1,'banner',100,'首页banner1','#','1435642012.png','','',1),(2,'banner',100,'首页banner2','#','1435642060.png','','',1),(3,'friends',100,'Yxcms','http://www.yxcms.net','1435642319.png','','Yxcms是一款高效,灵活,实用,免费的企业建站系统',1);
/*!40000 ALTER TABLE `yx_link` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `yx_member_group`
--
...
--
-- Dumping data for table `yx_member_group`
--

LOCK TABLES `yx_member_group` WRITE;
/*!40000 ALTER TABLE `yx_member_group` DISABLE KEYS */;
INSERT INTO `yx_member_group` VALUES (1,'未登录','member/infor|member/order|member/news|member/photo'),(2,'普通会员','');
/*!40000 ALTER TABLE `yx_member_group` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `yx_members`
--
...
--
-- Dumping data for table `yx_members`
--

LOCK TABLES `yx_members` WRITE;
/*!40000 ALTER TABLE `yx_members` DISABLE KEYS */;
INSERT INTO `yx_members` VALUES (1,2,'test','','d707c24bd27660ca7d65870027fb9218',0,0,'test','123@qq.cpaa','','','',1526393512,'127.0.0.1',1526393512,'127.0.0.1',0),(2,2,'123','','df85a226d7e42ef723f21c4c48352b1a',0,0,'123','bydoll@me.com','','','20180608/thumb_1528421985.jpg',1528421560,'172.20.11.163',1528421560,'172.20.11.163',0),(3,2,'123456','','d707c24bd27660ca7d65870027fb9218',0,0,'1','123456@qq.com','','','',1528422845,'172.20.32.14',1528422845,'172.20.32.14',0);
/*!40000 ALTER TABLE `yx_members` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `yx_method`
--
...
--
-- Dumping data for table `yx_method`
--

LOCK TABLES `yx_method` WRITE;
/*!40000 ALTER TABLE `yx_method` DISABLE KEYS */;
INSERT INTO `yx_method` VALUES (1,1,0,'admin','后台登陆管理',1),(2,1,1,'index','管理员管理',1),(4,1,1,'admindel','管理员删除',0),(5,1,1,'adminedit','管理员编辑',0),(6,1,1,'adminlock','管理员锁定',0),(7,1,1,'group','权限管理',1),(8,1,1,'groupedit','管理组编辑',0),(9,1,1,'groupdel','管理组删除',0),(10,10,0,'news','资讯管理',1),(11,10,10,'index','已有资讯',1),(12,10,10,'add','添加资讯',1),(13,10,10,'edit','资讯编辑',0),(14,10,10,'del','资讯删除',0),(15,10,10,'lock','资讯锁定',0),(16,10,10,'recmd','资讯推荐',0),(17,17,0,'dbback','数据库管理',1),(18,17,17,'index','数据库备份',1),(19,17,17,'recover','备份恢复',0),(20,17,17,'detail','备份详细',0),(21,17,17,'del','备份删除',0),(22,22,0,'index','后台面板',0),(23,22,22,'index','后台首页',0),(24,22,22,'login','登陆',0),(25,22,22,'logout','退出登陆',0),(26,22,22,'verify','验证码',0),(27,22,22,'welcome','服务器环境',0),(28,28,0,'set','全局设置',1),(29,28,28,'index','网站设置',1),(30,30,0,'sort','分类管理',1),(31,30,30,'index','栏目列表',1),(32,30,30,'edit','分类编辑',0),(33,30,30,'del','分类删除',0),(160,150,150,'delpic','图集单张图删除',0),(277,0,0,'appmanage','应用管理',1),(85,28,28,'menuname','后台功能',1),(159,150,150,'images_upload','图片批量上传',0),(158,10,10,'FileManagerJson','编辑器上传管理',0),(157,10,10,'UploadJson','编辑器上传',0),(150,150,0,'photo','图集管理',1),(151,150,150,'index','已有图集',1),(152,150,150,'add','添加图集',1),(153,150,150,'edit','图集编辑',0),(154,150,150,'del','图集删除',0),(155,150,150,'lock','图集锁定',0),(156,150,150,'recmd','图集推荐',0),(174,10,10,'cutcover','封面图剪切',0),(236,30,30,'PageUploadJson','单页上传',0),(235,30,30,'pageedit','单页编辑',0),(234,30,30,'pageadd','添加单页栏目',0),(233,30,30,'photoedit','图集栏目编辑',0),(232,30,30,'photoadd','添加图集栏目',0),(231,30,30,'newsedit','文章栏目编辑',0),(230,30,30,'newsadd','添加文章栏目',0),(182,28,28,'clear','网站缓存',1),(188,188,0,'link','友情链接',1),(189,188,188,'index','链接列表',1),(190,188,188,'add','添加链接',1),(191,188,188,'edit','链接编辑',0),(192,188,188,'del','链接删除',0),(228,1,1,'adminnow','账户管理',1),(229,188,188,'lock','锁定',0),(237,30,30,'PageFileManagerJson','单页上传管理',0),(238,238,0,'fragment','碎片管理',1),(239,238,238,'index','碎片列表',1),(240,238,238,'add','碎片添加',1),(241,238,238,'edit','碎片编辑',0),(242,238,238,'del','碎片删除',0),(243,238,238,'UploadJson','编辑器上传',0),(244,238,238,'FileManagerJson','编辑器上传管理',0),(245,28,28,'tpchange','前台模板',1),(251,30,30,'pluginadd','添加应用栏目',0),(252,30,30,'pluginedit','应用栏目编辑',0),(258,258,0,'extendfield','自定义表',1),(259,258,258,'index','自定义表列表',1),(260,258,258,'tableadd','添加自定义表',1),(261,258,258,'tableedit','拓展表编辑',0),(262,258,258,'tabledel','拓展表删除',0),(263,258,258,'fieldlist','字段列表',0),(264,258,258,'fieldadd','添加字段',0),(265,258,258,'fieldedit','编辑字段',0),(266,258,258,'fielddel','字段删除',0),(267,258,258,'file','文件上传',0),(268,10,10,'ex_field','字段拓展',0),(269,150,150,'ex_field','字段拓展',0),(270,30,30,'linkadd','添加自定义栏目',0),(271,30,30,'linkedit','自定义栏目编辑',0),(283,0,0,'member','会员管理(应用)',1),(288,10,10,'colchange','资讯转移栏目',0),(289,150,150,'colchange','图集转移栏目',0),(290,150,150,'UploadJson','图集编辑器上传',0),(291,150,150,'FileManagerJson','图集编辑器上传管理',0),(292,28,28,'tplist','模板文件列表',0),(293,28,28,'tpadd','模板文件添加',0),(294,28,28,'tpedit','模板文件编辑',0),(295,28,28,'tpdel','删除模板文件',0),(296,28,28,'tpgetcode','获取模板内容',0),(297,258,258,'meslist','自定义表信息',0),(298,258,258,'mesedit','自定义表信息添加',0),(299,258,258,'mesedit','自定义表信息编辑',0),(300,258,258,'mesdel','自定义表信息删除',0),(331,258,258,'meslock','自定义表信息审核',0),(301,30,30,'add','添加栏目',1),(302,30,30,'extendadd','添加表单栏目',0),(303,30,30,'extendedit','表单栏目编辑',0),(304,30,30,'placelist','内容定位列表',1),(305,30,30,'placeadd','添加内容定位',1),(306,30,30,'placeedit','定位编辑',0),(307,30,30,'placedel','定位删除',0),(308,308,0,'tags','TAG标签',1),(309,308,308,'index','标签列表',1),(310,308,308,'del','删除标签',0),(311,308,308,'hits','编辑点击量',0),(312,308,308,'add','生成标签',1),(313,308,308,'mesup','文档数量更新',0),(314,314,0,'files','附件管理',1),(315,314,314,'index','上传文件管理',1),(316,314,314,'del','删除文件',0),(317,10,10,'orderchange','列表ajax排序',0),(318,150,150,'orderchange','列表ajax排序',0),(319,30,30,'orderchange','列表ajax排序',0),(320,17,17,'sqlrun','SQL执行',1),(321,30,30,'cutcover','栏目封面剪切',0),(322,238,238,'saveimage','图片本地化',0),(323,10,10,'saveimage','图片本地化',0),(324,10,10,'delcover','删除封面图',0),(325,30,30,'delcover','删除封面图',0),(326,30,30,'pagesaveimage','图片本地化',0),(328,30,30,'sortsmove','栏目批量移动',0),(329,30,30,'sortsedit','栏目批量编辑',0),(330,30,30,'ifmenu','栏目设置隐藏',0),(332,258,258,'mesadd','自定义表添加信息',0),(333,308,308,'hadd','手动添加标签',0),(334,308,308,'edit','标签编辑',0),(335,335,0,'seo','SEO优化',1),(336,335,335,'sitemap','SiteMap',1);
...
--
-- Dumping data for table `yx_order_detail`
--

LOCK TABLES `yx_order_detail` WRITE;
/*!40000 ALTER TABLE `yx_order_detail` DISABLE KEYS */;
/*!40000 ALTER TABLE `yx_order_detail` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `yx_orders`
--
...
--
-- Dumping data for table `yx_orders`
--

LOCK TABLES `yx_orders` WRITE;
/*!40000 ALTER TABLE `yx_orders` DISABLE KEYS */;
/*!40000 ALTER TABLE `yx_orders` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `yx_page`
--
...
--
-- Dumping data for table `yx_page`
--

LOCK TABLES `yx_page` WRITE;
...
--
-- Table structure for table `yx_photo`
--
...
--
-- Dumping data for table `yx_photo`
--

LOCK TABLES `yx_photo` WRITE;
/*!40000 ALTER TABLE `yx_photo` DISABLE KEYS */;
INSERT INTO `yx_photo` VALUES (1,',000000,100002','100017,100021,100022,100024','admin','常熟市文化广电新闻出版局','','','1506300215571546842590.png','新闻出版,广电,文化','常熟市文化广电新闻出版局','1506300215571546842590.png ,1506300215591877540619.png ,1506300216001891940230.png ','首页,列表样式一,列表样式二','&lt;span style=&quot;color:#333333;font-family:\\\'Microsoft YaHei\\\', simsun, \\\'Helvetica Neue\\\', Arial, Helvetica, sans-serif;font-size:14px;line-height:normal;text-align:center;white-space:normal;background-color:#FFFFFF;&quot;&gt;&lt;span style=&quot;color:#333333;font-family:arial, 宋体, sans-serif;font-size:14px;line-height:24px;text-indent:28px;white-space:normal;background-color:#FFFFFF;&quot;&gt;根据《中共苏州市委、苏州市人民政府关于印发〈常熟市人民政府机构改革方案〉的通知》（苏委〔2009〕275号）和《中共常熟市委、常熟市人民政府关于印发〈常熟市人民政府机构改革实施意见〉的通知》（常发〔2010〕4号），设立常熟市文化广电新闻出版局，挂“常熟市文物局”、“常熟市版权局”牌子，为市政府工作部门，正科级建制&lt;/span&gt;&lt;/span&gt;','default/column/content','photo_content',100,0,31,1,1435644924,'',0),(2,',000000,100002','100016,100020,100023,100025','admin','小胖妞模板网','','','1506300220031481440664.png','模板','小胖妞模板网','1506300220031481440664.png ,1506300220051919311843.png ,1506300220071549770218.png ','首页,栏目页,模板页','小胖妞模板网','default/column/content','photo_content',100,0,31,1,1435645163,'',0),(3,',000000,100002','100018,100020,100021,100024','admin','北京外国语大学','','','1506300229482129600064.png','大学,外国语,北京','北京外国语大学','150630022159159647826.png ,1506300222001905899246.png ,1506300229482129600064.png ','列表页,内容页,首页','北京外国语大学','default/column/content','photo_content',100,0,31,1,1435645256,'',0),(4,',000000,100002','100019,100020,100023,100025','admin','美浩工作室','','','150630023220650531797.png','工作室','美浩工作室','150630023220650531797.png ,1506300232221386468141.png ,1506300232241145919893.png ','首页,案例页,论坛页','美浩工作室','default/column/content','photo_content',100,0,31,1,1435645876,'',0),(5,',000000,100002','100019,100020,100023,100025','admin','中电六所智能系统有限公司','','','150630023349974356615.png','有限公司,系统,智能','中电六所智能系统有限公司','150630023349974356615.png ,1506300233501594117165.png ','首页,列表页','&lt;span style=&quot;color:#333333;font-family:\\\'Microsoft YaHei\\\', simsun, \\\'Helvetica Neue\\\', Arial, Helvetica, sans-serif;font-size:14px;line-height:normal;text-align:center;white-space:normal;background-color:#FFFFFF;&quot;&gt;中电六所智能系统有限公司&lt;/span&gt;','default/column/content','photo_content',100,0,31,1,1435646005,'',0),(6,',000000,100002','','admin','网云工作室','','','150630024342113548484.png','工作室','网云工作室','150630024342113548484.png ,150630024343509801399.png ','首页,列表页','网云工作室','default/column/content','photo_content',100,0,32,1,1435646436,'',0),(7,',000000,100011','','admin','山水之间人文茶器','','','150630030053419355515.jpg','人文,山水,人心,长久,温暖,景德镇,之间,本色,手工','山水间 本色手作盖碗 人文茶器 景德镇纯手工盖碗\r\n人文茶器温暖人心的长久陪伴','1506300300501970643183.jpg ,150630030052472540922.jpg ,150630030053419355515.jpg ,1506300300541547700613.jpg ','圆筒,长底,圆体,传统','&lt;p&gt;\r\n	山水间本色手作盖碗,人文茶器&amp;nbsp;\r\n&lt;/p&gt;\r\n&lt;p&gt;\r\n	景德镇纯手工盖碗\r\n&lt;/p&gt;\r\n&lt;p&gt;\r\n	人文茶器温暖人心的长久陪伴\r\n&lt;/p&gt;\r\n&lt;p&gt;\r\n	&lt;br /&gt;\r\n&lt;/p&gt;','default/column/content','photo_pcontent',100,0,31,1,1435647617,'',3),(8,',000000,100011','','admin','手工紫砂壶','','','1506300305431242487463.jpg','手工','手工紫砂壶','1506300305392063905464.jpg ,150630030541852991339.jpg ,15063003054262323237.jpg ,1506300305431242487463.jpg ',',,,','紫砂壶长久以来，即被人们推崇为理想的注茶器。它优良的实用功能，在明清两代的文献中即有所记载。明清两代人们认为茶壶之所以“黜银锡及闽豫瓷，而尚宜陶”，是由于紫砂壶能发出茶之色、香、味，并且既不夺香，又煮熟汤气。关于“越宿不馊”的说法也有其一定的道理。','default/column/content','photo_pcontent',100,0,30,1,1435647826,'',4),(9,',000000,100011','','admin','创意咖啡杯','','','1506300307401269555756.jpg','咖啡,创意','创意咖啡杯','150630030737380344725.jpg ,1506300307381538704174.jpg ,1506300307401269555756.jpg ,150630030741882276299.jpg ','熊,兔子,猫头鹰,狗','骨质瓷（Bone china）： 简称骨瓷，亦称骨灰瓷，生产始于英国，学界一般认为第一个成功生产出骨质瓷的英国人是约西亚· 斯波德（Josiah Spode）（1755-1827年）。乔西亚.斯波德将煅烧后的骨头与瓷土和矿物熔剂直接混合而成为传统的硬质瓷原料，在19世纪初试验成功。随后他又开始进行生产骨瓷配方的系统性研究，1821年底，骨灰和瓷石多少的比例被“标准化”，当时，人们认为以长石为熔剂含骨灰46%的坯料生产出的瓷器是最好的产品。','default/column/content','photo_pcontent',100,0,31,1,1435648021,'',5),(10,',000000,100011','','admin','传统咖啡研磨机','','','150630030930848913083.jpg','咖啡,传统','传统咖啡研磨机','150630030929260152539.jpg ,150630030930848913083.jpg ,1506300309311307190140.jpg ,15063003093246117802.jpg ','顶柄,侧柄,双柄,侧柄','德国人对机械的要求高，讲究精细，这款德国Zassenhaus 40098 Santiago 实木手摇咖啡研磨机的研磨器拥有锥毛刺磨床专利权，由高品质的特殊钢材制成，经久耐用。独特的研磨控制系统，只需调整手摇柄下方的螺钉即可精确控制粉末的研磨粗细研磨度，顺时针调整为粗，逆时针为细。同时也能确保产生因研磨导致的较少热量，保留咖啡豆原始的香气与营养成分。实木外壳清新自然，造型高雅大方。','default/column/content','photo_pcontent',100,0,30,1,1435648143,'',6);
/*!40000 ALTER TABLE `yx_photo` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `yx_place`
--
...
--
-- Dumping data for table `yx_place`
--

LOCK TABLES `yx_place` WRITE;
...
--
-- Table structure for table `yx_sort`
--
...
--
-- Dumping data for table `yx_sort`
--

LOCK TABLES `yx_sort` WRITE;
/*!40000 ALTER TABLE `yx_sort` DISABLE KEYS */;
INSERT INTO `yx_sort` VALUES (100001,3,',000000','系统介绍','aboutus',0,0,'20150630/thumb_1435644326.png',1,100,1,'page/index','page_index','yxcms,简洁,简单,快捷','Yxcms是一款高效,灵活,实用,免费的企业建站系统,基于PHP和mysql技术,让您拥有更加专业的企业建站和企业网站制作服务。采用三级缓存：数据库缓存、模板缓存、静态缓存，可使网站数据达到百万级负载.采用功能与显示分离设计，灵活的标签库和任意拓展的插件机制，让您随心所欲，将DIY进行到底。拥有建站各种实用功能，摒弃各种复杂繁琐的功能操作。卓越的用户体验，让您使用起来方便明了。遵循BSD开源协议，不对用户做任何功能限制，保证用户二次商业开发使用。','',0),(100002,2,',000000','模板演示','demoshow',340,340,'',1,100,1,'photo/index','photo_index,photo_content','yxcms,模板,演示','yxcms模板演示','10',0),(100003,1,',000000','建站知识','knowledge',225,76,'',1,100,1,'news/index','news_index,news_content','网站建设,基本常识','网站建设常识','10',0),(100004,1,',000000,100003','后台技术','background',225,76,'',2,100,1,'news/index','news_indexs,news_content','网站,后台,知识','网站后台知识','10',0),(100005,1,',000000,100003','前端技术','frontend',225,76,'',2,100,1,'news/index','news_index,news_content','网站,前端,概括,介绍','网站前端概括介绍','10',0),(100006,1,',000000,100003','推广知识','promotion',225,76,'',2,100,1,'news/index','news_indexs,news_content','网站,推广,知识','网站推广知识','10',0),(100007,1,',000000,100003,100005','前端基础','frontbase',225,76,'',3,100,1,'news/index','news_index,news_content','网站,前端,基础,介绍','网站前端基础介绍','10',0),(100008,1,',000000,100003,100005','前端框架','frontframe',225,76,'',3,100,1,'news/index','news_index,news_content','前端,框架,介绍','主流和非主流的前端框架介绍','10',0),(100009,1,',000000,100003,100005,100007','JavaScript','javascript',225,76,'',4,100,1,'news/index','news_index,news_content','JavaScript,入门,介绍','JavaScript入门介绍','10',0),(100010,1,',000000,100003,100005,100007','Css','css',225,76,'',4,100,1,'news/index','news_index,news_content','Css,入门,介绍','Css入门介绍','10',0),(100011,2,',000000','产品展示','products',271,271,'',1,100,1,'photo/index','photo_indexp,photo_pcontent','产品,演示','产品展示','10',18),(100012,6,',000000','留言本','guestbook',0,0,'',1,100,1,'extend/index','extend_guestbook','在线留言','在线留言','10||感谢您的留言',12),(100013,2,',000000','行业','100013',271,271,'',1,100,0,'photo/index','photo_index,photo_content','','','10',0),(100014,2,',000000','风格','100014',271,271,'',1,100,0,'photo/index','photo_index,photo_content','','','10',0),(100015,2,',000000','颜色','100015',271,271,'',1,100,0,'photo/index','photo_index,photo_content','','','10',0),(100016,2,',000000,100013','互联网','100016',271,271,'',2,100,0,'photo/index','photo_index,photo_content','','','10',0),(100017,2,',000000,100013','政府','100017',271,271,'',2,100,0,'photo/index','photo_index,photo_content','','','10',0),(100018,2,',000000,100013','学校','100018',271,271,'',2,100,0,'photo/index','photo_index,photo_content','','','10',0),(100019,2,',000000,100013','科技','100019',271,271,'',2,100,0,'photo/index','photo_index,photo_content','','','10',0),(100020,2,',000000,100014','现代','100020',271,271,'',2,100,0,'photo/index','photo_index,photo_content','','','10',0),(100021,2,',000000,100014','民族','100021',271,271,'',2,100,0,'photo/index','photo_index,photo_content','','','10',0),(100022,2,',000000,100014','艳丽','100022',271,271,'',2,100,0,'photo/index','photo_index,photo_content','','','10',0),(100023,2,',000000,100014','简洁','100023',271,271,'',2,100,0,'photo/index','photo_index,photo_content','','','10',0),(100024,2,',000000,100015','红色','red',271,271,'',2,100,0,'photo/index','photo_index,photo_content','','','10',0),(100025,2,',000000,100015','蓝色','blue',271,271,'',2,100,0,'photo/index','photo_index,photo_content','','','10',0),(100026,2,',000000,100015','黄色','yellow',271,271,'',2,100,0,'photo/index','photo_index,photo_content','','','10',0),(100027,6,',000000','内容评论','100027',0,0,'',1,100,0,'extend/index','extend_index','','','10||留言成功等待审核',7);
/*!40000 ALTER TABLE `yx_sort` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `yx_tags`
--
...
--
-- Dumping data for table `yx_tags`
--

LOCK TABLES `yx_tags` WRITE;
/*!40000 ALTER TABLE `yx_tags` DISABLE KEYS */;
INSERT INTO `yx_tags` VALUES (1,'为什么','',0,0,1439525250),(2,'搭建','',0,0,1439525250),(3,'网站','',0,0,1439525250),(4,'究竟','',0,0,1439525250),(5,'选择','',0,0,1439525250),(6,'企业','',0,0,1439525250),(7,'作为','',0,0,1439525250),(8,'后台','',0,0,1439525250),(9,'语言','',0,0,1439525250),(10,'越来越','',0,0,1439525250),(11,'使用','',0,0,1439525250),(12,'功能','',0,0,1439525250),(13,'需要','',0,0,1439525250),(14,'更加','',0,0,1439525250),(15,'可以','',0,0,1439525250),(16,'我们','',0,0,1439525250),(17,'其他','',0,0,1439525250),(18,'简单','',0,0,1439525250),(19,'易于','',0,0,1439525250),(20,'希望','',0,0,1439525250),(21,'喜欢','',0,0,1439525250),(22,'以及','',0,0,1439525250),(23,'丰富','',0,0,1439525250),(24,'扩展','',0,0,1439525250),(25,'目标','',0,0,1439525250),(26,'拥有','',0,0,1439525250),(27,'所在','',0,0,1439525250),(28,'一切','',0,0,1439525250),(29,'人员','',0,0,1439525250),(30,'这里','',0,0,1439525250),(31,'地方','',0,0,1439525250),(32,'贡献','',0,0,1439525250),(33,'开发','',0,0,1439525250),(34,'一个','',0,0,1439525250),(35,'一直','',0,0,1439525250),(36,'欢迎','',0,0,1439525250),(37,'加入我们','',0,0,1439525250),(38,'帮助','',0,0,1439525250),(39,'性能','',0,0,1439525250),(40,'卓越','',0,0,1439525250),(41,'所有','',0,0,1439525250),(42,'的方式','',0,0,1439525250),(43,'暴露','',0,0,1439525250),(44,'出来','',0,0,1439525250),(45,'因为','',0,0,1439525250),(46,'框架','',0,0,1439525250),(47,'开发者','',0,0,1439525250),(48,'高性能','',0,0,1439525250),(49,'学习','',0,0,1439525250),(50,'针对','',0,0,1439525250),(51,'直接','',0,0,1439525250),(52,'对象','',0,0,1439525250),(53,'只是','',0,0,1439525250),(54,'为了','',0,0,1439525250),(55,'任意','',0,0,1439525250),(56,'目的','',0,0,1439525250),(57,'编写','',0,0,1439525250),(58,'根据','',0,0,1439525250),(59,'优化','',0,0,1439525250);
...
-- Dump completed on 2018-06-08  1:57:37
