 <?php if(!defined('APP_NAME')) exit;?>   
       <script type="text/javascript">
        ...
        <!--评论表单-->
        <div class="padding line-small height-little border-dotted">
            <form action="{$sorts['100027']['url']}" method="post" id="info" >
               <input type="hidden" name="type" value="2"><!--评论的类型,用于区分于其他图集、单页等评论-->
               <input type="hidden" name="title" value="{$info['title']}"><!--标题-->
               <input type="hidden" name="sortname" value="{$sorts[$pid]['name']}"><!--分类-->
               <input type="hidden" name="aid" value="{$info['id']}"> <!--图集ID-->
