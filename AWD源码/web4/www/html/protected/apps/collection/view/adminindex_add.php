 ...
 var hode='<img src="__PUBLIC__/admin/images/minus.gif">';
  ...
  $('.exsort a').click(function(){
	...
	$('#sort').change(function(){
		...
		if(tpc[paths]['type']==2){
			$(".newsfiled").remove();
      $('#extend').after('<tr class="photofiled"><td align="right">图集规则：</td><td><input type="text" value="" name="photolistrule" size="30"/></td><td class="inputhelp"><font color="red">暂不支持</font></td></tr><tr class="photofiled"><td align="right">图集描述规则：</td><td><input type="text" value="" name="conlistrule" size="30"/></td><td class="inputhelp"><font color="red">暂不支持</font></td></tr>');
		}else{
			$(".photofiled").remove();
			$('#extend').after('<tr class="newsfiled"><td align="right">来源：</td><td><input type="text" value="" name="origin" size="20"/></td><td class="inputhelp">用于资讯来源字段</td></tr>');
		}
   });
  });
...
<div class="list_head_m">
		<div class="list_head_ml">当前位置：【采集规则添加】</div>
        ...
        <form action="{url('adminindex/add')}" method="post" id="info" name="info">
        <ul class="tab_conbox" id="tab_conbox">
           <li class="tab_con">
           <table width="100%" border="0" cellpadding="0" cellspacing="1"  class="all_cont">
			<tr>
				<td align="right">项目名称：</td>
				<td><input id="sitename" type='text' value="" name="pname" /></td>
				<td class="inputhelp"></td>
			</tr>
      <tr>
        <td align="right">列表页地址：</td>
        <td><input type='text' value="" name="url" id="url"  size="50" /></td>
        <td class="inputhelp">网址中*将根据以下分页设置替换</td>
      </tr>
            <tr>
              <td align="right">分页设置：</td>
              <td><input type='text' value="" name="pages" size="30" /></td>
      ...
      <tr>
        ...
        <td class="inputhelp"><input type="hidden" value="" name="type" id="type"></td>
      </tr>
        ...
        <tr>
          ...
          <td><input type='text' value="" name="listsrcrule" size="30" /> </td>
       ...
       <li class="tab_con">
        ...
        <tr>
          ...
          <td><input type='text' value="" name="titlerule" size="30"/></td>
          <td class="inputhelp">用以获取标题</td>
        </tr>
        <tr>
        <td align="right">后台发布账户：</td>
        <td><input  type='text' value="admin" name="account" /></td>
        <td class="inputhelp"></td>
      </tr>
        <tr>
            <td align="right">状态：</td>
            <td align="left">
                <input type="checkbox" name="ispass" value="1" checked="checked"> 审核
        ...
        <tr>
          ...
          <td><input type='text' value="" name="picturerule" size="30"/></td>
          <td class="inputhelp">用以获取封面图</td>
        </tr>
        <tr>
          <td align="right">关键词规则：</td>
          <td><input type='text' value="" name="keywordsrule" size="30"/></td>
          <td class="inputhelp">用以获取SEO关键词</td>
        </tr>
        <tr>
          <td align="right">描述规则：</td>
          <td><input type='text' value="" name="descriptionrule" size="30"/></td>
          <td class="inputhelp">用以获取SEO描述</td>
        </tr>
        <tr>
          <td align="right">内容规则：</td>
          <td><input type='text' value="" name="contentrule" size="30"/></td>
          <td class="inputhelp">用以获取SEO描述</td>
        </tr>
        <tr>
        <td align="right">内容替换：</td>
        <td><textarea name="replaces" cols="60" rows="5" ></textarea></td>
        <td class="inputhelp">格式：需要替换的字符|替换后的字符，一行一个</td>
      </tr>
         <tr>
            <td align="right">前台模型/方法：</td>
            <td align="left"><input type="text" value="default/column/content" name="method" id="method" size="25"></td>
            <td class="inputhelp"></td>
         </tr>
         <tr>
          ...
          <tr>
            ...
            <td align="left"><input name="hitsrule" type="text" value="1,100" size="6"/></td>
            <td class="inputhelp">格式：1,100 随机在1到100之间生成</td>
          </tr> 
          <tr>
            <td align="right">发表时间范围：</td>
            <td align="left"><input name="addtimerule" id="addtimerule" type="text" value="" size="40"/></td>
      ...
      <table width="100%" border="0" cellpadding="0" >
		<tr>
			<td align="center" ><input type="submit" value="添 加" class="btn btn-primary btn-small"></td>
		</tr>	
      </table>
     </form>
     <table width="100%" border="0" cellpadding="0" cellspacing="1"  class="all_cont">
        <tr>
          <td>.xxx表示class属性,#xxx表示id属性,包含关系使用空格表示.<br><a href="http://www.phpddt.com/manual/simplehtmldom_1_5/manual.htm" target="_blank">simple_html_dom</a></td>
        </tr>
      </table>
</div>