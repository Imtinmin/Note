...
<div class="list_head_m">        
         ...
         <form action="{url('tags/edit',array('id'=>$info['id']))}"  method="post" id="info">
         <table width="100%" border="0" cellpadding="0" cellspacing="1"   class="all_cont">
          ...
          <tr>
            ...
            <td><input type="text" name="url" size="30" value="{$info['url']}"></td>
            <td align="left" class="inputhelp">http://开头网址</td>
          </tr>
          <tr>
          <td align="right"></td>
             <td align="left"><input class="btn btn-small btn-primary" type="submit" value="编辑"></td>
