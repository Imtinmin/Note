...
<div class="list_head_m"><div class="list_head_ml">当前位置：【图集添加】</div></div>
  ...
  <table class="all_cont" width="100%" border="0" cellpadding="5" cellspacing="1"   >
    ...
    <tr>
      ...
      <td align="left"><input type="text"  name="picture" id="picture"  size="20">
    ...
    <tr>
      ...
      <td align="left"  colspan="2"><textarea name="content" id="content" style=" width:100%;height:400px;visibility:hidden;"></textarea><br><input type="checkbox" name="iflink" value="1">替换Tag链接</td>
    </tr>
    <tr>
