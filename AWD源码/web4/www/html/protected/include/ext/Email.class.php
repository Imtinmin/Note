...
class Email
{
    ...
    public function Email($config = array()) 
    {
		...
		self::$config['SMTP_USERNAME']=isset($config['SMTP_USERNAME'])?$config['SMTP_USERNAME']:'404133748@qq.com';//smtp服务器帐号，如：你的qq邮箱
		...
		self::$config['SMTP_FROM_TO']=isset($config['SMTP_FROM_TO'])?$config['SMTP_FROM_TO']:'404133748@qq.com';//发件人邮件地址
		self::$config['SMTP_FROM_NAME']=isset($config['SMTP_FROM_NAME'])?$config['SMTP_FROM_NAME']:'YXcms官方';//发件人姓名
