...
CREATE TABLE `yx_collectrules` (  `id` int(20) NOT NULL AUTO_INCREMENT,  `pname` varchar(100) NOT NULL COMMENT '采集项目名',  `url` varchar(255) NOT NULL COMMENT '列表url',  `replaces` text NOT NULL COMMENT '内容替换',  `banhtml` varchar(255) NOT NULL COMMENT '禁止的html标签',  `sort` varchar(350) NOT NULL COMMENT '栏目id',  `exsort` varchar(350) NOT NULL,  `pages` text NOT NULL COMMENT '分页设置',  `numlimit` int(5) NOT NULL COMMENT '数量限制',  `listrangrule` varchar(100) NOT NULL COMMENT '列表范围规则',  `listsrcrule` varchar(100) NOT NULL COMMENT '内容src规则',  `account` varchar(25) NOT NULL COMMENT '发布账户',  `conrangrule` varchar(100) NOT NULL COMMENT '内容范围',  `titlerule` varchar(100) NOT NULL COMMENT '标题规则',  `places` varchar(100) NOT NULL COMMENT '内容定位',  `picturerule` varchar(100) NOT NULL COMMENT '封面图规则',  `keywordsrule` varchar(100) NOT NULL COMMENT '关键字规则',  `descriptionrule` varchar(100) NOT NULL COMMENT '描述规则',  `contentrule` varchar(100) NOT NULL COMMENT '内容规则',  `method` varchar(100) NOT NULL,  `tpcontent` varchar(100) NOT NULL,  `norder` int(4) NOT NULL,  `recmd` tinyint(1) NOT NULL,  `hitsrule` varchar(100) NOT NULL,  `ispass` tinyint(1) NOT NULL,  `origin` varchar(30) NOT NULL,  `addtimerule` varchar(100) NOT NULL,  `releids` varchar(255) NOT NULL,  `photolistrule` varchar(100) NOT NULL COMMENT '图集src规则',  `conlistrule` varchar(100) NOT NULL COMMENT '图片描述规则',  `exrule` text NOT NULL COMMENT '拓展字段规则',  `lasttime` int(11) NOT NULL,  PRIMARY KEY (`id`)) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
...
CREATE TABLE `yx_extend_product` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `pinpai` varchar(250) NOT NULL,  `caizhi` varchar(250) NOT NULL,  `chandi` varchar(250) NOT NULL,  `jiage` varchar(250) NOT NULL,  PRIMARY KEY (`id`)) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;
...
CREATE TABLE `yx_fragment` (  `id` int(10) NOT NULL AUTO_INCREMENT,  `title` varchar(255) NOT NULL,  `sign` varchar(255) NOT NULL COMMENT '前台调用标记',  `content` text NOT NULL,  PRIMARY KEY (`id`)) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
CREATE TABLE `yx_link` (  `id` int(10) NOT NULL AUTO_INCREMENT,  `groupname` varchar(255) NOT NULL,  `norder` int(5) NOT NULL COMMENT '排序',  `name` varchar(30) NOT NULL COMMENT '站点名',  `url` varchar(300) NOT NULL COMMENT '站点地址',  `picture` varchar(30) NOT NULL COMMENT '本地logo',  `logourl` varchar(50) NOT NULL COMMENT '远程logo',  `info` varchar(300) NOT NULL COMMENT '介绍',  `ispass` tinyint(1) NOT NULL,  PRIMARY KEY (`id`)) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
...
CREATE TABLE `yx_member_group` (  `id` int(3) NOT NULL AUTO_INCREMENT,  `name` varchar(30) NOT NULL,  `notallow` text NOT NULL,  PRIMARY KEY (`id`)) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
...
CREATE TABLE `yx_method` (  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,  `rootid` int(10) unsigned NOT NULL,  `pid` float unsigned NOT NULL,  `operate` varchar(255) NOT NULL,  `name` varchar(255) NOT NULL,  `ifmenu` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否菜单显示',  PRIMARY KEY (`id`),  KEY `pid` (`pid`)) ENGINE=MyISAM AUTO_INCREMENT=337 DEFAULT CHARSET=utf8;
...
CREATE TABLE `yx_news` (  `id` int(20) NOT NULL AUTO_INCREMENT,  `sort` varchar(350) NOT NULL COMMENT '类别',  `exsort` varchar(350) NOT NULL,  `account` char(15) NOT NULL COMMENT '发布者账户',  `title` varchar(60) NOT NULL COMMENT '标题',  `places` varchar(100) NOT NULL,  `color` varchar(7) NOT NULL COMMENT '标题颜色',  `picture` varchar(80) NOT NULL,  `keywords` varchar(300) NOT NULL COMMENT '关键字',  `description` varchar(600) NOT NULL,  `content` text NOT NULL COMMENT '内容',  `method` varchar(100) NOT NULL COMMENT '方法',  `tpcontent` varchar(100) NOT NULL COMMENT '模板',  `norder` int(4) NOT NULL COMMENT '排序',  `recmd` tinyint(1) NOT NULL COMMENT '推荐',  `hits` int(10) NOT NULL COMMENT '点击量',  `ispass` tinyint(1) NOT NULL,  `origin` varchar(30) NOT NULL COMMENT '来源',  `addtime` int(11) NOT NULL,  `releids` varchar(255) NOT NULL,  `extfield` int(10) NOT NULL DEFAULT '0' COMMENT '拓展字段',  PRIMARY KEY (`id`),  FULLTEXT KEY `sort` (`sort`)) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8;
...
CREATE TABLE `yx_tags` (  `id` int(10) NOT NULL AUTO_INCREMENT,  `name` varchar(60) NOT NULL,  `url` varchar(255) NOT NULL,  `hits` int(10) NOT NULL DEFAULT '0',  `mesnum` int(10) NOT NULL DEFAULT '0',  `addtime` int(11) NOT NULL,  PRIMARY KEY (`id`)) ENGINE=MyISAM AUTO_INCREMENT=60 DEFAULT CHARSET=utf8;
