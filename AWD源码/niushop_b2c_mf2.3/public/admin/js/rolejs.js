...
function AllCheckBoxClick(event) {
    ...
    if ($(eventSrc).attr("dir") == "title") {
        ...
        if ($(eventSrc).attr("checked") == "checked") {
        	...
        	$(eventSrc).parents("li").find("input[type=checkbox]").prop('checked', true);
            $(eventSrc).parents('li').find("input[type=checkbox]").parent().addClass('selected');
        } else {
        	$(eventSrc).parents("li").find("input[type=checkbox]").removeProp('checked');
    ...
    if ($(eventSrc).attr("dir") == "parent") {
        // 选中旗下所有的checkBox
        if ($(eventSrc).attr("checked") == "checked") {
        	$(eventSrc).parents("tr").find("input[type=checkbox]").prop('checked', true);
        	$(eventSrc).parents("tr").find("input[type=checkbox]").parent().addClass('selected');
        } else {
        	$(eventSrc).parents("tr").find("input[type=checkbox]").removeProp('checked');
        	$(eventSrc).parents("tr").find("input[type=checkbox]").parent().removeClass('selected');
        }
    }
    // 当选中的是son
